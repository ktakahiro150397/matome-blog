...
マークダウン本文以外は出力しないでください。

要約は、見出しや箇条書きなどを使って、内容を整理して分かりやすくしてください。
要約の内容は、元のテキストの内容を正確に反映し、重要なポイントを押さえたものにしてください。
要約の長さは、元のテキストの内容に応じて調整してください。必要に応じて、重要な情報を強調したり、具体的な例を挙げたりしてください。
---
{text}
---
"""
